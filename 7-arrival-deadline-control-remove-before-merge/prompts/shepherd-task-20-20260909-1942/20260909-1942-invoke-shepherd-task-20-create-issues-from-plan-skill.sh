#!/usr/bin/env bash
set -euo pipefail
timestamp=20260909-1942
log_dir_full=/Users/edburns/workareas/dd-3061974-01-cargotracker-shepherd-control/7-arrival-deadline-control-remove-before-merge/prompts/shepherd-task-20-20260909-1942
...
prompt_file=/Users/edburns/workareas/dd-3061974-01-cargotracker-shepherd-control/7-arrival-deadline-control-remove-before-merge/prompts/shepherd-task-20-20260909-1942/20260909-1942-invoke-shepherd-task-20-create-issues-from-plan-skill.md
...
"/Users/edburns/.copilot/plugins/shepherd-task/scripts/assert-stage20-result.sh" "$log_dir_full/stage-20-result.json"
